...
contract MockBtcProof {
    function validateTx(
        ...
        return BtcProof.validateTx(blockHash, txProof, txOutIx);
    }
...
contract BtcProofTest is DSTest {
    ...
    function testParseTx() public {
        ...
        assertEq(
            keccak256(t.inputs[0].script),
            keccak256(hex"16001407bf360a5fc365d23da4889952bcb59121088ee1")
        );
        ...
        assertEq(
            keccak256(t.outputs[0].script),
            keccak256(hex"a914ae2f3d4b06579b62574d6178c10c882b9150374087")
        );
